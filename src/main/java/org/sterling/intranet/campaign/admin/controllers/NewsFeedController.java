...
public class NewsFeedController
{
    ...
    public ResponseEntity<?> selectArticleFromNewsFeed(@PathVariable("articleId") String articleId, @CookieValue("currentCampaign") String cookie)
    {
        ...
        else
        {
            ...
            Collection<Comment> comments = commentServices.selectALlCommentByArticleIdAndState(article.getArticleId(), "Active");
            if(!comments.isEmpty())
            {
                      ...
                      @RequestParam(value = "questionId") String questionId) throws ParseException
    {
        ...
        else
        {
            ...
            if(employeeDetails != null)
            {
                ...
                System.err.println(question.getTitle() + " Title of the question");
                System.err.println(question.getTitle() + " Title of the question");
                System.err.println(question.getTitle() + " Title of the question");
                System.err.println(question.getTitle() + " Title of the question");
                System.err.println(question.getTitle() + " Title of the question");
    ...
    @RequestMapping(value = "/news-feed/article/{articleId}", params = "articleId", method = RequestMethod.GET)
    public ResponseEntity<?> fetchAllCommentsInOneArticle(@RequestParam(name = "articleId") String articleId)
    {
        Map<String, Object> response = new HashMap<String, Object>();
        Collection<Comment> comments = commentServices.selectALlCommentByArticleIdAndState(articleId, "Active");
        if(!comments.isEmpty())
        {
            response.put("comments", comments);
            response.put("hasComments", HttpStatus.OK);
    ...
    @RequestMapping(value = "/news-feed/article/{articleId}", params = "commentId", method = RequestMethod.OPTIONS)
    public ResponseEntity<?> inactiveCommentInArticle(@RequestParam(name = "commentId", required = false) Integer commentId)
    {
        Map<String, Object> response = new HashMap<String, Object>();
        
        response = commentServices.inactiveCommentInArticleByCommentId(commentId, "Inactive");
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
